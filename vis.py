...
def find_attraction(latlong):
    ...
    query_result = google_places.nearby_search(location = latlong, keyword='Park', radius = 3000, types=[types.TYPE_PARK])
